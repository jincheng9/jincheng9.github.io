...
white spaces. Previous approaches for TV white space identifcation are spectrum sensing and geo-location database. However, spectrum sensing is too expensive and geo-location database use signal propagation modeling to determine white spaces, which is too conservative and does not work in indoors. 
...
<img src="../imgs/wiser_arch.jpg" alt="wiser architecture" style="width: 666px;"/>
